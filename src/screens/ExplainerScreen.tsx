    ...
    <ScreenWrapper navigation={navigation}>
      <View style={styles.wrapper}>
        ...
        <View style={styles.board}>
          ...
          <Text style={styles.text}>
            {
              'Julia sets are the same, although this time the value of "c" is different. There are many many Julia sets, all with a different complex number for the value of "c". With the Mandelbrot set, the c value is the complex number represented by that coordinate. Each Julia set has a different value for c, which is the same at every coordinate.'
            }
          </Text>
        </View>
        ...
        <View style={styles.board}>
          ...
          <Text style={styles.text}>
            {
              "The only other factor here involves the speed at which these iterations reach infinity. Coordinates that don't ever reach infinity are marked as black. The ones that reach infinity quicker you apply a different colour to. In this app, coordinates that reach infinity quickest are marked as blue."
            }
          </Text>
        </View>
